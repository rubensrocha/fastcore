...
<h5 class="card-title mb-0">Отзыв пользователя: <b><?=$ur['login']; ?></b> <small class="badge badge-warning float-right"><b><?=date("d.m.Y в H:i",$ur['date']); ?></b></small><hr class="my-1"></h5>
...
<center>
	...
	<h4 class="card-title">Оставьте свой отзыв! <br/><small>Для нас очень важно ваше мнение о проекте!</small></h4><hr class="my-1">
	<div class="form-group mb-0">Ваш отзыв:
	<textarea class="form-control" name="content" rows="1"></textarea></div>
	<div class="form-group"><button name="asd" type="submit" class="btn btn-success btn-lg mt-1">Написать</button></div>
	</form>
</center>
<? } 
