...
# Уровни
if($dep <= 99) {$day = 5;}
elseif ($dep >= 100 and $dep < 999) {$day = rand(5,  20);}
elseif ($dep >= 1000 and $dep < 2499) {$day = rand(25, 50);}
elseif ($dep >= 2500 and $dep < 4999) {$day = rand(100, 250);}
elseif ($dep >= 5000) {$day = 250;}
...
Сумма бонуса генерируется случайно от <font class="text-danger"><b>0.05</b></font> до <font class="text-danger"><b>2.50</b></font> руб.<br/>
