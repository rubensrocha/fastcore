                ...
                if (isset($_POST['new_pass'])) {
                    ...
                    if ($pass !== false && strtolower($pass) === strtolower($user['pass'])) {
                        if ($pass_new !== false) {
                            ...
                            echo '<div class="alert alert-warning">Новый пароль имеет неверный формат!</div>';
                        }
                    } else {
                        echo '<div class="alert alert-danger">Старый пароль заполнен неверно!</div>';
                    }
                }
                ?>
                ...
                <form action="" method="POST">
                    ...
                    if ($ps['payeer'] == '0') {
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="text" name="payeer" placeholder="Пример P111111111"
                                   value=""/>
                        </div>
                        <?php
                    } else {
                    ...
                    if ($ps['qiwi'] == '0') {
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="text" name="qiwi" placeholder="Пример +79201234567"
                                   value=""/>
                        </div>
                        <?php
                    } else {
                    ...
                    if ($ps['yandex'] == '0') {
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" type="text" name="yandex" placeholder="Пример 40012345600000"
                                   value=""/>
                        </div>
                        <?php
                    } else {
                    ...
                    ?>
                    <?php
                    if ($ps['payeer'] && $ps['qiwi'] && $ps['yandex'] > 0) {
                    } else {
                        ?>
                        <center>
                            <button class="btn btn-success mt-2" name="save_wallet" type="submit">Сохранить реквизиты
                            </button>
                        </center>
                        <?php
                    } ?>
