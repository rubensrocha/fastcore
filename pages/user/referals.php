...
<div class="alert bg-light text-center">
    Приглашайте в проект своих друзей и знакомых! Вы будете <br>получать <b>10%</b> от каждого пополнения баланса вашим
    рефералом сразу на счет для вывода! <br> Ниже представлена ссылка для привлечения и количество приглашенных Вами
    людей.<br>
</div>
...
<center class="container col-lg-8">
    ...
    <div class="input-group mb-2">
        ...
        <div class="input-group-append">
            <button type="button" class="btn btn-success" data-toggle="collapse" data-target="#demo">Рекламные
                материалы
            </button>
        </div>
    </div>
