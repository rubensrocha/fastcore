...
if ($users['ip'] == $ip){ $errors[] = 'Регистрация с этого IP ('.$real_ip.') уже производилась!'; }
...
<div class="form-group mb-1"><input class="form-control" name="login" type="text" placeholder="Логин" value=""></div>
<div class="form-group mb-1"><input class="form-control" name="email" type="email" placeholder="Email" value=""></div>
<div class="form-group mb-1"><input class="form-control" name="pass" type="password" placeholder="Пароль" value=""></div>
