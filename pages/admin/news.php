...
if(strlen($title) >= 3){
	...
	} else echo '<div class="alert alert-danger">Заголовок не может быть менее 3х символов</div>';
}
?>
...
if($db->NumRows() != 1){ echo '<div class="alert alert-danger">Новость с таким ID не найдена</div>'; return;}
