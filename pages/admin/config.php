...
<input type="text" name="sum_a<?=$p['id']; ?>" value="<?=$p['sum_a']; ?>" class="form-control">
<input type="text" name="sum_b<?=$p['id']; ?>" value="<?=$p['sum_b']; ?>" class="form-control">
<input type="text" name="sum_x<?=$p['id']; ?>" value="<?=$p['sum_x']; ?>" class="form-control">
</div>
<?php
}
?>
...
<?php
if (isset($_POST['cnf'])) {
	$coint = intval($_POST['coint']);
	$bounty = intval($_POST['bounty']);
	$acc_pay = intval($_POST['acc_pay']);
	$min_s = (float)$_POST['min_s'];
	$p_sell = intval($_POST['p_sell']);
	$p_swap = intval($_POST['p_swap']);
