...
<li class="list-group-item bg-light">Информация о пользователе <b class="float-right"><?=$user['login']; ?></b></li>
...
Заблокирован: <span class="float-right"><?=($user['ban'] > 0) ? '<span class="badge badge-danger">Да</span>' : '<span class="badge badge-success">Нет</span>'; ?></span>
</li>
