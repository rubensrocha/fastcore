<div class="col-md-2 p-0 navbar-dark bg-dark fcmenu">
    ...
    <ul class="navbar-nav">
        <li class="nav-item"><a class="nav-link" href="/<?= $adm ?>/"><i class="fa fa-bar-chart-o"></i> Статистика</a>
        </li>
        <li class="nav-item"><a class="nav-link" href="/<?= $adm ?>/news"><i class="fa fa-rss"></i> Новости</a></li>
        <li class="nav-item"><a class="nav-link" href="/<?= $adm ?>/st/inserts"><i class="fa fa-plus"></i>
                Пополнения</a></li>
        <li class="nav-item"><a class="nav-link" href="/<?= $adm ?>/st/payouts"><i class="fa fa-minus"></i> Выплаты</a>
        </li>
        <li class="nav-item"><a class="nav-link" href="/<?= $adm ?>/st/store"><i class="fa fa-drupal"></i> Список
                покупок</a></li>
        <li class="nav-item"><a class="nav-link" href="/<?= $adm ?>/users"><i class="fa fa-users"></i> Пользователи</a>
        </li>
        <li class="nav-item"><a class="nav-link" href="/<?= $adm ?>/pers"><i class="fa fa-drupal"></i> Персонажи</a>
        </li>
        <li class="nav-item"><a class="nav-link" href="/<?= $adm ?>/config"><i class="fa fa-gear"></i> Настройки</a>
        </li>
    </ul>
</div>
