...
if (isset($pg->params[1])) {
    $rid = ((int)$pg->params[1] > 0) ? (int)$pg->params[1] : 1;
...
<div class="jumbotron mb-2">
    ...
    <p>Супербыстрый скрипт для создания сайтов на PHP-8</p>
    <hr>
    <div class="row mb-4" style="font-weight: bold;font-size: 105%;">
        <div class="col-lg-2 col-md-3"><small>Скрипт</small><br/>FastCore v<?= FastCoreVersion ?></div>
        <div class="col-lg-2 col-md-3"><small>Релиз</small><br/>08.08.2020</div>
        <div class="col-lg-6 col-md-6"><small>Требования</small><br/>php 8.0, mysqli, utf-8, apache, FastCGI</div>
    </div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="wrapper p-3">
            ...
            <p>Данный скрипт предназначен для создания сайтов любой сложности, в скрипте имеется базовый функционал,
                необходимый для изначального пользования, всеми привычные разделы от предшественников, теперь все это
                работает намного быстрее и безопаснее. Мы потрудились сделать этот скрипт максимально простым и удобным
                и к тому же масштабируемым, эта версия скрипта нуждается в доработке и потерпит некоторые изменения,
                скрипт нельзя продавать в чистом виде так как является публичным. Если у Вас есть идеи и разбираетесь в
                кодинге воплощайте их в данный движок, создавай модули, дизайны и прочие наработки они будут полезными.
            </p>
        </div>
    </div>
    <div class="col-lg-4">
