...
от <b class="text-danger"><?=$bon_p['sum_a']; ?></b> до <b class="text-danger"><?=$bon_p['sum_b']; ?></b> руб. <br/> <b><span class="text-white bg-danger" style="padding: 3px 5px; border-radius: 1em;">бонус <span style="color: #ffef02;">+<?=$bon_p['sum_x']*100; ?>%</span></span></b></div>
</div>
<?php
	}
?>
